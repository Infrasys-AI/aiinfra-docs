...
![使用 Static Batching 的推理负载情况示意图](../images/05Infer03Dispatch/01ContinousBatching02.png)
...
![Mistral-7B 在单卡 A100 上 prefill 和 Decode 阶段不同 Batch 下对吞吐影响示意图](../images/05Infer03Dispatch/01ContinousBatching06.png)
...
![Batching 实现中调度器和请求队列示意图](../images/05Infer03Dispatch/01ContinousBatching07.png)
...
![Orca 计算图拆分示意图](../images/05Infer03Dispatch/01ContinousBatching09.png)
...
![Static Batching 的缺陷分析](../images/05Infer03Dispatch/01ContinousBatching12.png)
