...
本节将以 OpenAI 的 [Scaling Laws for Neural Language Models](https://arxiv.org/abs/2001.08361) 这篇论文为主，研究 Transformer 架构的语言建模损失对模型架构、模型大小、训练资源以及用于训练过程的数据这些因素的依赖关系。结尾将会辅以其他研究成果，介绍影响 LLM 预训练效果的重要因素。
...
![预测下一个 token](./../images/00Summary/01ScalingLaw04.png)
...
![模型性能与计算量、数据集大小、模型规模之间的关系](../images/00Summary/01ScalingLaw01.png)
...
![batch size](../images/00Summary/01ScalingLaw07.png)

在充分大 batch size 下，训练步长与模型性能间存在幂律关系，且此规律在不同参数规模的模型架构中均呈现一致性。

![训练步长](../images/00Summary/01ScalingLaw08.png)
...
![模型参数与数据](../images/00Summary/01ScalingLaw03.png)
![模型参数与数据](../images/00Summary/01ScalingLaw05.png)
...
![样本效率](../images/00Summary/01ScalingLaw02.png)
...
![作者使用三种不同方法的预测最优模型大小，发现当时的大模型训练严重不足。这也导致 2021 年大家复现 GPT3 都没有做出特别好的效果。](../images/00Summary/01ScalingLaw06.png)
...
![最优学习率和 batch size](../images/00Summary/01ScalingLaw09.png)
...
![最优学习率和 batch size](../images/00Summary/01ScalingLaw10.png)
...
![上下文长度](../images/00Summary/01ScalingLaw11.png)
...
![数据分布偏移](../images/00Summary/01ScalingLaw12.png)
