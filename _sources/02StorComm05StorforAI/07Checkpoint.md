...
![CKPT 在大模型训练中的作用](../images/02StorComm05StorforAI/07CKPT01.png)
...
![CKPT 的过程](../images/02StorComm05StorforAI/07CKPT02.png)
...
![CKPT 切分与恢复的过程](../images/02StorComm05StorforAI/07CKPT03.png)

### 3.检查点类型

#### ①单基线差异检查点（one-shot differential CKPT）

![单基线差异检查点](../images/02StorComm05StorforAI/07CKPT0301.png)
...
![连续增量检查点](../images/02StorComm05StorforAI/07CKPT0302.png)
...
![间歇差异检查点](../images/02StorComm05StorforAI/07CKPT0303.png)
...
![大模型常规训练中计算存储的关系](../images/02StorComm05StorforAI/07CKPT04.png)

### 1.存储 CKPT 至数据湖中

![大模型常规训练中计算存储的关系](../images/02StorComm05StorforAI/07CKPT06.png)
...
![大模型常规训练中计算存储的关系](../images/02StorComm05StorforAI/07CKPT07.png)
...
![大模型常规训练中计算存储的关系](../images/02StorComm05StorforAI/07CKPT08.png)
...
![大模型常规训练中计算存储的关系](../images/02StorComm05StorforAI/07CKPT09.png)
...
![包含量化压缩步骤的 CKPT 过程](../images/02StorComm05StorforAI/07CKPT10.png)
