...
!!!!!!!!
1）大模型生成的，缺乏自己思考；2）MobileCLIP（2023）、Meta CLIP 2（2025）、TripletCLIP（NeurIPS 2024）、PiNI（2025）、SigLIP系列

!!!!!!!
CLIP的技术演进，要系统地思考和梳理，不能只用大模型，没有灵魂了，没有重点了。
