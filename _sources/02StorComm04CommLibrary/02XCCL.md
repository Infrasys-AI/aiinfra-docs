...
![基于 NCCL 的通信库](../images/02StorComm04CommLibrary/02XCCL01.png)
...
![XCCL 在 AI 系统中的位置](../images/02StorComm04CommLibrary/02XCCL02.png)
...
![华为 HCCL](../images/02StorComm04CommLibrary/02XCCL03.png)
...
![ring 网络](../images/02StorComm04CommLibrary/02XCCL04.png)
...
![不同算法的差异](../images/02StorComm04CommLibrary/02XCCL05.png)
...
![AMD ROCm 生态](../images/02StorComm04CommLibrary/02XCCL06.png)
...
![AMD MI300X GPU Infinity Fabric](../images/02StorComm04CommLibrary/02XCCL07.png)

## Intel oneCCL

oneCCL（oneAPI Collective Communications Library） 是 Intel 开发的一个高效通信库，作为 oneAPI 生态系统的一部分，支持不同设备之间的通信。

![oneCCL](../images/02StorComm04CommLibrary/02XCCL08.png)
...
![oneCCL 性能](../images/02StorComm04CommLibrary/02XCCL09.png)

分别以 MPI 和 oneCCL 作为集合通信的后端，可以看出 oneCCL 通信效率明显高于 MPI。

![MPI 和 oneCCL 通信比较](../images/02StorComm04CommLibrary/02XCCL10.png)
...
![Meta Gloo](../images/02StorComm04CommLibrary/02XCCL11.png)
...
![Pytorch with Gloo](../images/02StorComm04CommLibrary/02XCCL12.png)
...
![MSCCL 通信效率](../images/02StorComm04CommLibrary/02XCCL13.png)
...
![MSCCL 减少时延 ](../images/02StorComm04CommLibrary/02XCCL14.png)
...
![阿里灵骏 ACCL](../images/02StorComm04CommLibrary/02XCCL15.png)
...
![阿里 ACCL 组网](../images/02StorComm04CommLibrary/02XCCL16.png)
...
![ACCL 优于 NCCL](../images/02StorComm04CommLibrary/02XCCL17.png)
...
![Halving-Doubling with rank-mapping](../images/02StorComm04CommLibrary/02XCCL18.png)
...
![腾讯计算加速套件 TACO Kit](../images/02StorComm04CommLibrary/02XCCL19.png)
...
![腾讯云星脉网络架构](../images/02StorComm04CommLibrary/02XCCL20.png)
...
![TCCL 异构并行通信优化的性能评估](../images/02StorComm04CommLibrary/02XCCL21.png)
...
![百度百舸 AI 异构计算平台](../images/02StorComm04CommLibrary/02XCCL22.png)
...
![All_reduce 算法百度 BCCL 与 NCCL 对比](../images/02StorComm04CommLibrary/02XCCL23.png)

![All_gather 算法百度 BCCL 与 NCCL 对比](../images/02StorComm04CommLibrary/02XCCL24.png)
