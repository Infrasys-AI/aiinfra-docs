...
![OSI 参考模型](../images/02StorComm04CommLibrary/1osimodule.png)
...
![OSI 和 TCP/IP](../images/02StorComm04CommLibrary/2osicomparewithTCP-IPmodule.png)
...
![p2p 通信](../images/02StorComm04CommLibrary/3p2pcommunication.png)
...
![同步与异步](../images/02StorComm04CommLibrary/4blockingnon-blocking.png)
...
![MPI_Bcast 过程](../images/02StorComm04CommLibrary/5MPI_Bcast.png)
...
![MPI_Gather 过程](../images/02StorComm04CommLibrary/6MPI_Gather.png)
...
![Barrier](../images/02StorComm04CommLibrary/7Barrier.png)

## MPI 程序运行

MPI 程序编程模式为迭代式“计算 + 通信”，程序可以分为计算块和通信块。每个程序可以独立完成计算块，计算完成后进行交互（通信或同步）。交互后进入下一阶段计算，直到所有任务完成，程序退出。

![MPI 程序编程模式](../images/02StorComm04CommLibrary/8MPIprogramming.png)
...
![MPI 程序](../images/02StorComm04CommLibrary/9MPIInterface.png)
