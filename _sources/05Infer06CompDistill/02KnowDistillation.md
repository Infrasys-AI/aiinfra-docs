...
![iigngsljglsngjglsn](../images/05Infer06CompDistill/3_role.png)

LLMs 的通用知识蒸馏流程是⼀个结构化、系统化的过程，旨在将知识从复杂的教师模型迁移到较简单的学⽣模型。如下图所示，整体流程可分为四个阶段，每一阶段均对应着蒸馏在不同功能维度上的作用。

![图1：蒸馏过程的3个作用](../images/05Infer06CompDistill/蒸馏流程.png)
...
![算法图片](../images/05Infer06CompDistill/Algorithm2.png)
...
![](../images/05Infer06CompDistill/F3-1.png)
...
![](../images/05Infer06CompDistill/T3-1.png)
...
![](../images/05Infer06CompDistill/T3-2.png)
...
![](../images/05Infer06CompDistill/T3-3.png)
...
![](../images/05Infer06CompDistill/T3-4.png)

上表验证了该方法对于编码器模型 BGE 同样有效，通过混合现有模型即可提高新任务的准确性。关于模型合并所需少量示例的数量。

![](../images/05Infer06CompDistill/T3-5.png)
...
![](../images/05Infer06CompDistill/F4-1.png)
...
![](../images/05Infer06CompDistill/T4-1.png)
...
![](../images/05Infer06CompDistill/T5-5.png)
...
![](../images/05Infer06CompDistill/T5-6.png)
