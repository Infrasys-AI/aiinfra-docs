...
![图片描述](../images/05Infer06CompDistill/3_role.png)
...
![图片描述](../images/05Infer06CompDistill/KD_pipeline.png)
...
2. **分布不匹配问题**： 使用固定数据集进行蒸馏时，学生模型在训练和推理阶段面临不同的分布：
   ...
   ![mismatch](../images/05Infer06CompDistill/mismatch.png)
...
3. 监督训练：最小化学生和教师模型在 token 层面 logits 之间的差异（如 KL 散度）
   ...
   ![teacher_drive](../images/05Infer06CompDistill/teacher_drive.png)
...
> 
> ![图片描述](../images/05Infer06CompDistill/Divergence.png)
> 
...
> ![mode_seeking](../images/05Infer06CompDistill/mode_seeking.png)
...
![Algorithm](../images/05Infer06CompDistill/Algorithm.png)
...
3. 将参考 SFT 策略替换为教师策略（改变不同方法的分配策略）
   ...
   ![LOSS](../images/05Infer06CompDistill/LOSS.png)
...
![tasks_compare](../images/05Infer06CompDistill/tasks_compare.png)
...
![table21](../images/05Infer06CompDistill/table21.png)
...
![trade_off](../images/05Infer06CompDistill/trade_off.png)
...
![RLFT](../images/05Infer06CompDistill/RLFT.png)
...
![](../images/05Infer06CompDistill/OSD.png)
