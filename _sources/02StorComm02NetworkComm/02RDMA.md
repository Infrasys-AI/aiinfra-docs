...
![](../images/02StorComm02NetworkComm/02RDMA00.jpg)
...
![](../images/02StorComm02NetworkComm/02RDMA04.jpg)
...
![](../images/02StorComm02NetworkComm/02RDMA05.jpg)
...
![](../images/02StorComm02NetworkComm/02RDMA06.jpg)
...
![AI Infra02](../images/02StorComm02NetworkComm/02RDMA03.jpg)
...
![img](../images/02StorComm02NetworkComm/DCQCN_RPCPNP.png)
...
![img](../images/02StorComm02NetworkComm/DCQCN_CP.png)
...
![img](../images/02StorComm02NetworkComm/DCQCN_RP.png)
...
### ZTRCC
  基本工作原理
    ...
    ![img](../images/02StorComm02NetworkComm/ztrcc_flowchart.png) 
  ...
  如前所述，ZTR 的主要优势之一是能够提供 RoCE 功能，同时在普通 TCP/IP 流量中与非 RoCE 通信同时运行。ZTR 提供 RoCE 网络功能的无缝部署。通过添加 RTTCC 主动监控拥塞，ZTR 无需交换机配置即可提供数据中心范围的拥塞控制
    性能对比数据
    ![img](../images/02StorComm02NetworkComm/ztrcc_bandwidth.png)
