...
![AI 系统+大模型全栈架构图](../images/04Train01ParallelBegin/01Introduction01.png)
...
2.  **辅助工具**：提供强大的数据处理和 Tokenizer 功能，高效处理和转换数据，为基于 Transformer 结构的大语言模型（LLM）和视觉语言模型（VLM）等提供支持，确保模型生成高质量内容。
