...
![预测下一个token](../images/00Summary01ScalingLaw/01ScalingLaw04.png)
...
![作者使用三种不同方法的预测最优模型大小，发现当时的大模型训练严重不足。这也导致2021年大家复现GPT3都没有做出特别好的效果。](../images/00Summary01ScalingLaw/01ScalingLaw06.png)
...
![最优学习率和batch size](../images/00Summary01ScalingLaw/01ScalingLaw09.png)
...
![最优学习率和batch size](../images/00Summary01ScalingLaw/01ScalingLaw10.png)
